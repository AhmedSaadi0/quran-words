...
> واجهة عربية كاملة — RTL، خط Amiri للقرآن، وضع فاتح/داكن، وبحث مُطبَّع يتجاهل التشكيل.

<p align="center">
  <img src="screenshots/2026-08-27-020242_hyprshot.png" alt="البحث الموحد عن زور" width="100%" />
  <br />
  <sub><b>البحث الموحد</b> — كتابة <code>زور</code> في شريط البحث تُظهر الجذور (1) والمشتقات (7) والكلمات (5) والآيات مع ترقيم صفحات 20/صفحة</sub>
</p>

<p align="center">
  <img src="screenshots/2026-08-27-020257_hyprshot.png" alt="صفحة الجذر زور" width="100%" />
  <br />
  <sub><b>صفحة الجذر</b> — <code>زور</code> مع الملخص الذكي للمعنى العام، وتبويبات المعاني (8) والمصادر والمشتقات والكلمات والآيات (6) مع تمييز الكلمات المشتقة في سياق الآية</sub>
</p>

<details>
<summary>📐 ملاحظات العرض</summary>

- الخط القرآني: `Amiri` عبر `next/font` — كل آيات `font-quran text-xl leading-relaxed`.
- البحث: `frontend/src/components/search-bar.tsx` — debounce 300ms + دعم تشكيل + ترقيم صفحات `wPage/aPage`.
- الجذر: `frontend/src/app/roots/[root]/page.tsx` — كرت الملخص `bg-accent/30` مع `leading-9` لمنع تداخل الأسطر.
